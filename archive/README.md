> **Archived.** This is the earlier, Wine-based version of these scripts,
> from before a native Linux build of XwaInstallerManager existed. The
> maintained version lives in the repo root's [`README.md`](../README.md)
> and [`scripts/`](scripts/). This is kept only as a fallback in case the
> native-build approach doesn't pan out — see the repo root's
> [`docs/DESIGN-NOTES.md`](../docs/DESIGN-NOTES.md#relationship-to-archive).
